...
@endpush
@section('title', 'uBot | Lottery Silk Settings')
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Lottery Silk</li>
        ...
        <div class="col-lg-6 col-6">
            ...
            <div class="card card-primary">
                <div class="card-header ">
                    <h3 class="card-title ">Lottery Silk Settings</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                ...
                <form method="POST" action="{{ route('panel.event-lotterysilk') }}">
                    @csrf
