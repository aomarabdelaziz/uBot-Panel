...
@endpush
@section('title', 'uBot | Lottery Coins Settings')
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Lottery Coins</li>
        ...
        <div class="col-lg-6 col-6">
            ...
            <div class="card card-primary">
                <div class="card-header ">
                    <h3 class="card-title ">Lottery Coins Settings</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                ...
                <form method="POST" action="{{ route('panel.event-lotterycoins') }}">
                    @csrf
