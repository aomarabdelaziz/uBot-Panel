...
@endpush
@section('title', 'uBot | LPN Settings')
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Lucky Party Number</li>
        ...
        <div class="col-lg-6 col-6">
            ...
            <div class="card card-primary">
                <div class="card-header ">
                    <h3 class="card-title ">LPN Settings</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                ...
                <form method="POST" action="{{ route('panel.event-lpn') }}">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">Target Number</label>
                            <input type="number" class="form-control @error('TargetNumber') is-invalid @enderror" name="TargetNumber" value="{{ old('TargetNumber' , $data->TargetNumber) }}" placeholder="1">
                            @error('TargetNumber')
                            <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                            </span>
