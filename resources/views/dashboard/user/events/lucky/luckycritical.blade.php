...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Lucky Critical</li>
        ...
        <div class="col-lg-6 col-6">
            ...
            <div class="card card-primary">
                <div class="card-header ">
                    <h3 class="card-title ">Lucky Critical Settings</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                ...
                <form method="POST" action="{{ route('panel.event-lc') }}">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">Cape Type</label>
                            <input type="number" class="form-control @error('CapeType') is-invalid @enderror" name="CapeType" value="{{ old('CapeType' , $data->CapeType) }}" placeholder="1">
                            @error('CapeType')
                            <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                            </span>
