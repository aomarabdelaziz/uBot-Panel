...
@endpush
@section('title', 'uBot | LPM Settings')
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Lucky Party Member</li>
        ...
        <div class="col-lg-6 col-6">
            ...
            <div class="card card-primary">
                <div class="card-header ">
                    <h3 class="card-title ">LPM Settings</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                ...
                <form method="POST" action="{{ route('panel.event-lpm') }}">
                    @csrf
                    <div class="card-body">
