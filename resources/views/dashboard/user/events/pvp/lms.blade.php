...
@endpush
@section('title', 'uBot | LMS Settings')
@section('breadcrumb')
        ...
        <div class="col-lg-6 col-6">
            ...
            <div class="card card-primary">
                <div class="card-header ">
                    <h3 class="card-title ">LMS Settings</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                ...
                <form method="POST" action="{{ route('panel.event-lms') }}">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="exampleInputText">Play Method</label>

                            <select class="form-control" name="LMSPlayMethod">
                                <option value="PK" {{ ( $data->LMSPlayMethod == 'PK') ? 'selected' : '' }}> PK </option>
                                <option value="Cape" {{ ( $data->LMSPlayMethod == 'Cape') ? 'selected' : '' }}> Cape </option>
