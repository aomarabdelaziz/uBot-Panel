        ...
        <div class="col-lg-6 col-6">
            ...
            <div class="card card-primary">
                <div class="card-header ">
                    <h3 class="card-title ">PVP Settings</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                ...
                <form method="POST" action="{{ route('panel.event-pvp') }}">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">BattleDelay</label>
                            <input type="number" class="form-control @error('BattleDelay') is-invalid @enderror" name="BattleDelay" value="{{ old('BattleDelay' , $data->BattleDelay) }}" placeholder="1">
                            @error('BattleDelay')
                            <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                            </span>
