        ...
        <div class="col-lg-6 col-6">
            ...
            <div class="card card-primary">
                <div class="card-header ">
                    <h3 class="card-title ">GMKiller Settings</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                ...
                <form method="POST" action="{{ route('panel.event-gmkiller') }}">
                    @csrf
                    <div class="card-body">
