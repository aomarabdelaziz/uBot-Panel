...
@endpush
@section('title', 'uBot | Drunk Settings')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('panel.panel-home') }}">Panel</a></li>
    <li class="breadcrumb-item"><a href="#">Events</a></li>
    <li class="breadcrumb-item"><a href="#">Other Events</a></li>
    <li class="breadcrumb-item active">Drunk</li>
        ...
        <div class="col-lg-6 col-6">
            ...
            <div class="card card-primary">
                <div class="card-header ">
                    <h3 class="card-title ">Drunk Settings</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                ...
                <form method="POST" action="{{ route('panel.event-drunk') }}">
                    @csrf
                    <div class="card-body">
